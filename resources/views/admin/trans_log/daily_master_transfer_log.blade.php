              ...
              <div class="card">
                <div class="card-header p-3 pt-2 bg-transparent">
                  ...
                  <div class="text-end pt-1">
                    <p class="text-sm mb-0 text-capitalize">Daily Total Cash In</p>
            ...
            <div class="col-lg-3 col-md-6 col-sm-6 mt-sm-0 mt-4">
              <div class="card">
                <div class="card-header p-3 pt-2 bg-transparent">
                  ...
                  <div class="text-end pt-1">
                    <p class="text-sm mb-0 text-capitalize">Daily Total Cash Out </p>
             ...
             <div class="col-lg-3 col-md-6 col-sm-6 mt-sm-0 mt-4">
              <div class="card">
                <div class="card-header p-3 pt-2 bg-transparent">
                  ...
                  <div class="text-end pt-1">
                    <p class="text-sm mb-0 text-capitalize">Daily Total Profit </p>
                    <h4 class="mb-0">
                     @php
 ...
 <div class="col-12">
  <div class="card">
   ...
   <div class="card-header pb-0">
    <div class="d-lg-flex">
     <div>
      <h5 class="mb-0">Master To Agent Daily Status Dashboards</h5>
